							...
							<tbody>
								...
								>
									...
									<td scope="row">
										...
										<div v-if="isPickable">
											<a class="tooltip-add" role="button" @click="saveChoice(type,name)">
...
export default {
	...
	methods: {
		saveChoice(type, name) {
			this.$store.commit('userData/SET_CHOICES', { type, name });
		},
