module.exports = {
	...
	rules: {
		'node/no-exports-assign': ['error', 'always'],
		'node/no-extraneous-import': ['error', 'always'],
		'node/no-extraneous-require': ['error', 'always'],
		'node/no-missing-import': ['error', 'always'],
		'node/no-missing-require': ['error', 'always'],
		'node/no-unpublished-bin': ['error', 'always'],
		'node/no-unpublished-import': ['error', 'always'],
		'node/no-unpublished-require': ['error', 'always'],
		...
		'node/process-exit-as-throw': ['error', 'always'],
		'no-debugger': 'warn',
